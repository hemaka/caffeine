...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  computed: {
    caffeine: function caffeine() {
      return this.currentDrinks.caffeine * this.consumed;
    },
    serving: function serving() {
...
var render = function () {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _vm.currentDrinks != null
      ? _c("div", { staticClass: "card mt-2" }, [
          _c("div", { staticClass: "card-body" }, [
            _c("h5", { staticClass: "card-title" }, [
              _vm._v(
                "\n        " + _vm._s(_vm.currentDrinks.name) + "\n        "
              ),
              _c(
                "button",
                {
            ...
            _vm._v(" "),
            _c("p", [_vm._v(_vm._s(_vm.currentDrinks.description))]),
            _vm._v(" "),
            _vm.currentDrinks.unit.type == "serving" &&
            _vm.currentDrinks.unit.pack == "can"
              ? _c("div", { staticClass: "row" }, [
                  _c("div", { staticClass: "col-6" }, [
                    _vm._v(
                      "\n          " +
                        _vm._s(_vm.currentDrinks.caffeine) +
                        " mg / per serving\n        "
                    ),
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "col-6" }, [
                    _vm._v(
                      "\n          " +
                        _vm._s(_vm.currentDrinks.unit.val) +
                        " serving / per can\n        "
                    ),
                  ]),
                ])
            ...
            _vm._v(" "),
            _vm.currentDrinks.unit.type == "serving" &&
            _vm.currentDrinks.unit.pack == "none"
              ? _c("div", { staticClass: "row" }, [
                  _c("div", { staticClass: "col-6" }, [
                    _vm._v(
                      "\n          " +
            ...
            _vm._v(" "),
            _vm.currentDrinks.unit.type == "serving" &&
            _vm.currentDrinks.unit.pack == "fl"
              ? _c("div", { staticClass: "row" }, [
                  _c("div", { staticClass: "col-6" }, [
                    _vm._v(
                      "\n          " +
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.currentDrinks.unit.type == "fl"
              ? _c("div", { staticClass: "row" }, [
                  _c("div", { staticClass: "col-6" }, [
                    _vm._v(
                      "\n          " +
            ...
            _c("div", { staticClass: "form-group" }, [
              _c("label", { attrs: { for: "consumed" } }, [
                _vm._v("Drinks consumed"),
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "input-group mb-3" }, [
                _c("input", {
                  ...
                  domProps: { value: _vm.consumed },
                  on: {
                    input: function ($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.consumed = $event.target.value
                    },
                  },
                }),
                _vm._v(" "),
            ...
            _vm._v(" "),
            _c("div", { staticClass: "row" }, [
              _vm.caffeine <= _vm.safeCaffeine
                ? _c("div", { staticClass: "col" }, [
                    _vm._v("\n          You can drink "),
                    _c("span", { staticClass: "text-success" }, [
                      _vm._v(_vm._s(_vm.serving)),
                    ]),
                    _vm._v(
                      " serving " +
                        _vm._s(_vm.currentDrinks.name) +
                ...
                _c("h5", { staticClass: "card-title" }, [
                  ...
                  item.user_id == _vm.user.id
                    ? _c(
                        "button",
                        {
                          staticClass: "btn btn-sm btn-info float-end",
                          on: {
                            click: function ($event) {
                              return _vm.sel(item)
                            },
